...
$app->get('/make/database', function (Request $request, Response $response) {
    // db
...
$app->get('/read/database', function (Request $request, Response $response) {
    // db
    // $databasepath = 'sqlite:./application/database/db.sqlite';
    // $db  = new PDO($databasepath) or die("cannot open the database");
    ...
    //	"INSERT INTO Dogs (Breed, Name, Age) VALUES ('Golden-Doodle', 'Ellie', 4);");
    	...
    	{
    		print "<td>id: ".$row['Id']."</td><br/>";
    		print "<td>breed: ".$row['Breed']."</td><br/>";
    		print "<td>nake: ".$row['Name']."</td><br/>";
    		print "<td>age: ".$row['Age']."</td><br/>";
            print "<hr/>";
    	}
